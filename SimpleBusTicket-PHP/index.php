...
<head>
    ...
    <title>Travels Ticket Bookings</title>
    <!-- google fonts -->
...
<body>
    ...
    <header>
        <nav>
            <div>
                    <a href="#" class="nav-item nav-logo">Viraj_Travels</a>
    ...
    <section id="home">
        <div id="route-search-form">
            <h1>Viraj Travels Ticket Booking System</h1>

            <p class="text-center">Welcome to Viraj Travels Bus Ticket Booking System. Login now to manage bus tickets and much more. OR, simply scroll down to check the Ticket status using Passenger Name Record (PNR number)</p>
    ...
    <div id="block">
        ...
        <section id="about">
            <div>
                ...
                <p>
                    Planning a bus trip can be a hassle, especially when searching for the right bus operator in Atpadi (Sangali) India. Luckily, has simplified this process for you! With just a click of a button on the redBus website or application, you can easily access informative details about the exciting world of bus travel in India. Not only does redBus provide information about local landmarks and attractions in Atpadi (Sangali), but it also offers updated bus schedules, fares, timings, and other useful information to help you move seamlessly from one landmark to another. Before booking your bus ticket online, be sure to check out Viraj Tours And Travels Atpadi (Sangali) reviews on the redBus platform to make an informed decision. By booking your bus ticket on redBus, you can be assured of a hassle-free and convenient travel experience. Don't waste any more time searching for bus operators, book your ticket on redBus today and enjoy a stress-free journey!
        ...
        <footer>
        <p>
                        <i class="far fa-copyright"></i> <?php echo date('Y');?> - Viraj Travels Ticket Booking System
                        </p>
        </footer>
    </div>
